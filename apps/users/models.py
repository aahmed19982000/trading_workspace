...
class CustomUserManager(BaseUserManager):
    """مدير المستخدمين للتعامل مع البريد الإلكتروني كمعرف أساسي بدلاً من اسم المستخدم."""
...
class CustomUser(AbstractUser):
    ...
    avatar = models.ImageField('الصورة الشخصية', upload_to='avatars/', null=True, blank=True)
